...
class StoreProfileRequest extends FormRequest
{
    ...
    {
        return [
            'name' => ["required","string","min:3", Rule::unique('profiles', 'name')->where('last_name', $this->last_name)],
            'last_name' => ["required", "string", "min:3", Rule::unique('profiles', 'last_name')->where('name', $this->name)],
